...
# Created on: 2015-05-11 18:07:20
...
sub get {
    my ($self, $url) = @_;
    my $data_url = shift @{ $self->data } || '';

    confess "Data set up badly, '$url' doesn't match '$data_url'\n"
        if $url ne $data_url;
...
Mech - <One-line description of module's purpose>
